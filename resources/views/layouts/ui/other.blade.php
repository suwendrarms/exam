...
<html lang="en">
	...
	<head><base href="../../../../">
		<meta charset="utf-8" />
		<title>Software Engineer – Exam 4</title>
		...
		<!--end::Layout Themes-->
		<link rel = "icon" href = "{{ asset('ui/web/media/logos/logo-letter-3.png') }}" type = "image/x-icon">
				...
				<div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url(assets/media/bg/bg-1.jpg);">
					<div class="login-form text-center text-white p-7 position-relative overflow-hidden">
						...
						<div class="d-flex flex-center mb-15">
							<a href="#">
								<img src="{{ asset('ui/web/media/logos/logo-letter-3.png') }}" class="max-h-110px" alt="" />
							</a>
						</div>
						<!--end::Login Header-->
